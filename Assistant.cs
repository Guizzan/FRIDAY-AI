...
namespace GoogleAssistantWindows
{
    public class Assistant
    {
        ...
        public IClientStreamWriter<ConverseRequest> _requestStream;
        ...
        public bool _assistantResponseReceived = false;
        ...
        public void StopRecording(bool abort)
        {
            if (_waveIn != null)
            {
        ...
        public void ResetSendingAudio(bool send)
        {
            _writing = false;            
            _writeBuffer.Clear();
            _sendSpeech = send;
